...
namespace Music
{
    class Arrow
    {
        ...
        public Arrow(Control owner, Random random)
        {
            //Y軸を6ずつ移動する
            _intMvwd = 6;
        ...
        private void _Set()
        {
            ...
            while (true)
            {
                //同じ矢印が画面内に2個被らないように調節(被ると矢印が消えてしまう)
                if (this.Change == 1)
                {
        ...
        public bool _Miss()
        {
            ...
            {
                //
                if (Arrows[i].Top <= 4 && Arrows[i].Top >= 0)
                {
        ...
        public void _RotationReset()
        {
            this.Rotation = true;
        }

        public bool _RotationHantei()
        {
